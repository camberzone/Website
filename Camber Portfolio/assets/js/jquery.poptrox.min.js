		...
		$.fn.poptrox = function(options) {
			...
			// Settings
				var settings = $.extend({
					...
					fadeSpeed:						0,						// Global fade speed
					overlayColor:					'#000000',					// Overlay color
					overlayOpacity:					0.6,						// Overlay opacity
					overlayClass:					'poptrox-overlay',			// Overlay class
					windowMargin:					80,							// Window margin size (in pixels; only comes into play when an image is larger than the viewport)
					...
					usePopupLoader:					false,						// If true, show the popup loader
					...
					popupBackgroundColor:			'#FFFFFF00',					// (Default Style) Popup background color (when usePopupStyling = true)
					popupTextColor:					'#000000',					// (Default Style) Popup text color (when usePopupStyling = true)
					popupLoaderTextSize:			'2em',						// (Default Style) Popup loader text size
					popupCloserBackgroundColor:		'#0000005F',					// (Default Style) Popup closer background color (when usePopupStyling = true)
					popupCloserTextColor:			'#FFFFFF',					// (Default Style) Popup closer text color (when usePopupStyling = true)
					popupCloserTextSize:			'20px',						// (Default Style) Popup closer text size
					popupPadding:					40,							// (Default Style) Popup padding (when usePopupStyling = true)
			...
			// Variables
				...
				function updateWH() {
					...
					var maxw = windowWidth - dw, maxh = windowHeight - dh;
			...
			// Main
				...
				$this.find(settings.selector).each(function(index) {
					...
					imgcool.onload = function(){
						...
						img_for_photoswipe.w = imgcool.width;
						img_for_photoswipe.h = imgcool.height;
					}
